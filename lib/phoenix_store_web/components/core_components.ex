defmodule PhoenixStoreWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixStoreWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixStoreWeb.Gettext, "errors", msg, opts)
    end
  end
